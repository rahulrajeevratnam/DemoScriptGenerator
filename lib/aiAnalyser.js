...
- frameNumber is CRITICAL: it must be the 1-based index of the frame image you were sent that best shows this step's end state (the screen AFTER the action). Be precise — this frame will be used directly as the screenshot in the document.
